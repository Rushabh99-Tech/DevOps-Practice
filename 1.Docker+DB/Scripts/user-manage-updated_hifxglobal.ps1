...
function Process-Leaver {
    ...
    $csvPath = "$([Environment]::GetFolderPath('Desktop'))\${userName}_GroupMembership_HIFXGLOBAL.csv"

    # Define the OU path to move the disabled user
    $disabledUserOuPath = "OU=Disabled Users,OU=Disabled Accounts,OU=HiFX,DC=HIFXGlobal,DC=com"
